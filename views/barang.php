    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="my-4 text-center">Barang</h1>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div id="pagination-container" class="d-flex mb-3">
                            <a href="tambahbarang.php" class="btn btn-primary ms-2">Tambah Data</a>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-inline d-flex justify-content-evenly">
                                            <li><a href="./editbarang.php?id=<?= $data['id'] ?>" class="btn btn-success">Edit</a></li>
                                            <li>
                                                <form action="../proses/deletebarang.php" method="post">
