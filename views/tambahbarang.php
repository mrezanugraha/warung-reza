        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="col-md-8 m-auto card p-5 shadow -3 mb-5 bg-body rounded">
                        <form enctype="multipart/form-data" action="../proses/tambahbarang.php" method="post">					
                           <div class="mb-3">
                             <label for="exampleFormControlInput1" class="form-label">ID Barang</label>
                               <input name="id_barang" type="text" class="form-control id=exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="kategori_barang" type="text" class="form-control id=exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Harga Barang</label>
                                <input name="harga_barang" type="text" class="form-control id=exampleFormControlInput1">
                            </div>
