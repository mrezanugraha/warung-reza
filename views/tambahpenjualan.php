...
<html lang="en">
    ...
    <div id="layoutSidenav_content">
        ...
        <div class="container-fluid px-4">
                <h1 class="my-4 text-center">Tambah Penjualan</h1>
                <div class="col-md-8 m-auto card p-5 shadow -3 mb-5 bg-body rounded">
                        <form enctype="multipart/form-data" action="../proses/tambahpenjualan.php" method="post">					
                           <div class="mb-3">
                             <label for="exampleFormControlInput1" class="form-label">ID Penjualan</label>
                               <input name="id_penjualan" type="text" class="form-control id=exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="id_barang" class="form-control" id="exampleFormControlSelect1">
                                    ...
                                    while ($row_barang = mysqli_fetch_assoc($result_barang)) {
                                        ...
                                        echo "<option value=\"$id_barang\">$id_barang</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Jumlah Barang Terjual</label>
                                <input name="jumlah_barang_terjual" type="text" class="form-control id=exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
                             <label for="birthday">Tanggal Penjualan</label>
                                <br>
                                <input type="date" id="tanggal" name="tanggal_penjualan">
                            </div>
                            <div class="d-flex justify-content-around">
                                <button name="submit" class="btn btn-md btn-primary px-5 mt-2">Tambah</button>
                                <a href="./penjualan.php" class="btn btn-md btn-danger px-5 mt-2">Cancel</a>
                            </div>
                    </form>
                </div> 
            </div>
