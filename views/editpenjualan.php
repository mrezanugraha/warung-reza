...
<html lang="en">
    ...
    <div id="layoutSidenav_content">
        ...
        <div class="container-fluid px-4">
                <h1 class="my-4 text-center">Edit Penjualan</h1>
                <div class="col-md-8 m-auto card p-5 shadow -3 mb-5 bg-body rounded">
                        <form enctype="multipart/form-data" action="../proses/editpenjualan.php" method="post">	
                           ...
                           <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="jumlah_barang_terjual" type="text" class="form-control id=exampleFormControlInput1" value="<?= $data['jumlah_barang_terjual'] ?>">
                            </div>
                            <div class="mb-3">
