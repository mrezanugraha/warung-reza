        ...
        <nav class="sb-sidenav accordion sb-sidenav-secondary bg-warning" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link active text-black" href="./penerimaan.php">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="my-4 text-center">Penerimaan Barang</h1>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div id="pagination-container" class="d-flex mb-3">
                            <a href="tambahpenerimaan.php" class="btn btn-primary ms-2">Tambah Data</a>
                        </div>
                        <table id="datatablesSimple" class="table">
                            ...
                            <tbody>
                                <?php
                                    $query = "SELECT * FROM penerimaan_barang";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-inline d-flex justify-content-evenly">
                                            <li><a href="./editpenerimaan.php?id=<?= $data['id'] ?>" class="btn btn-success">Edit</a></li>
                                            <li>
                                                <form action="../proses/deletepenerimaan.php" method="post">
